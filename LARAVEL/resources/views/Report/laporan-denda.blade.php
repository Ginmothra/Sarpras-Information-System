        ...
        <div class="w-[90vw] p-6 ml-[18vw]">
            <div class="max-w-6xl mx-auto bg-white rounded-xl shadow-md p-6">
                <div class="flex items-center justify-between mb-2">
                    <div>
                        <h2 class="text-2xl font-semibold">📝 Laporan Denda</h2>
                        <p class="text-gray-700 mt-1 text-sm">Catatan Log Denda Siswa</p>
                    </div>
                </div>

                @if ($logs->isEmpty())
                    <div class="bg-yellow-100 text-yellow-800 px-4 py-3 rounded-md mt-4">
                        Tidak ada data log laporan denda siswa.
                    </div>
                @else
